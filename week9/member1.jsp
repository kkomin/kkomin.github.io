...
<%@ oage language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
...
<html>
    ...
    <section id="Area"><form id="formId">
        <div id="div1" class="class1">
            ...
            out.println("<input id='id12' class='class3' type='text' name='sName' size='20' amaxlength='50' value="'+sName +'/>");%>
        </div>
        ...
        <div id="div4">
            <footer><p>&copy; 2022 Made by Korea. All rights reserved.</p></footer>
        </div>
    </form></section>
    </body>
</html>
